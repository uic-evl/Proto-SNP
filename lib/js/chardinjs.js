...
(function() {
    ...
    (function($, window) {
        ...
        let chardinJs = class chardinJs {
            ...
            _get_top_offset(element) {
                return element.getAttribute('data-top') || 0;
            }

            _get_left_offset(element) {
                return element.getAttribute('data-left') || 0;
            }
            ...
            _place_tooltip(element, target_position, tooltip_layer) {
                ...
                switch (position) {
                    ...
                    case "left":
                    case "right":
                        let top_offset = this._get_top_offset(element);
                        ...
                        if(top_offset){
                            tooltip_layer.style.top = top_offset
                        }
                        else {
