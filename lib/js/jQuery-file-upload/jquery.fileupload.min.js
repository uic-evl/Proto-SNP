var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,k,a){c instanceof String&&(c=String(c));for(var b=c.length,d=0;d<b;d++){var e=c[d];if(k.call(a,e,d,c))return{i:d,v:e}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(c,k,a){c!=Array.prototype&&c!=Object.prototype&&(c[k]=a.value)};
...
g=a.uploadedBytes,m=a.maxChunkSize||f,h=this._blobSlice,t=c.Deferred(),n=t.promise(),l;if(!(this._isXHRUpload(a)&&h&&(g||m<f))||a.data)return!1;if(b)return!0;if(g>=f)return e.error=a.i18n("uploadedBytes"),this._getXHRPromise(!1,a.context,[null,"error",e.error]);var k=function(){var b=c.extend({},a),n=b._progress.loaded;b.blob=h.call(e,g,g+m,e.type);b.chunkSize=b.blob.size;b.contentRange="bytes "+g+"-"+(g+b.chunkSize-1)+"/"+f;d._initXHRData(b);d._initProgressListener(b);l=(!1!==d._trigger("chunksend",
null,b)&&c.ajax(b)||d._getXHRPromise(!1,b.context)).done(function(e,h,l){g=d._getUploadedBytes(l)||g+b.chunkSize;n+b.chunkSize-b._progress.loaded&&d._onProgress(c.Event("progress",{lengthComputable:!0,loaded:g-b.uploadedBytes,total:g-b.uploadedBytes}),b);a.uploadedBytes=b.uploadedBytes=g;b.result=e;b.textStatus=h;b.jqXHR=l;d._trigger("chunkdone",null,b);d._trigger("chunkalways",null,b);g<f?k():t.resolveWith(b.context,[e,h,l])}).fail(function(a,c,e){b.jqXHR=a;b.textStatus=c;b.errorThrown=e;d._trigger("chunkfail",
null,b);d._trigger("chunkalways",null,b);t.rejectWith(b.context,[a,c,e])})};this._enhancePromise(n);n.abort=function(){return l.abort()};k();return n},_beforeSend:function(a,b){0===this._active&&(this._trigger("start"),this._bitrateTimer=new this._BitrateTimer,this._progress.loaded=this._progress.total=0,this._progress.bitrate=0);this._initResponseObject(b);this._initProgressObject(b);b._progress.loaded=b.loaded=b.uploadedBytes||0;b._progress.total=b.total=this._getTotal(b.files)||1;b._progress.bitrate=
...
c.Deferred();this._slots.push(h);b=h.then(m)}else b=this._sequence=this._sequence.then(m,m);b.abort=function(){f=[void 0,"abort","abort"];return e?e.abort():(h&&h.rejectWith(g.context,f),m())};return this._enhancePromise(b)}return m()},_onAdd:function(a,b){var d=this,e=!0,f=c.extend({},this.options,b),g=b.files,m=g.length,h=f.limitMultiFileUploads,k=f.limitMultiFileUploadSize,n=f.limitMultiFileUploadSizeOverhead,l=0,r=this._getParamName(f),u=0;if(!m)return!1;k&&void 0===g[0].size&&(k=void 0);if((f.singleFileUploads||
h||k)&&this._isXHRUpload(f))if(f.singleFileUploads||k||!h)if(!f.singleFileUploads&&k){var p=[];var q=[];for(f=0;f<m;f+=1)if(l+=g[f].size+n,f+1===m||l+g[f+1].size+n>k||h&&f+1-u>=h)p.push(g.slice(u,f+1)),l=r.slice(u,f+1),l.length||(l=r),q.push(l),u=f+1,l=0}else q=r;else for(p=[],q=[],f=0;f<m;f+=h)p.push(g.slice(f,f+h)),l=r.slice(f,f+h),l.length||(l=r),q.push(l);else p=[g],q=[r];b.originalFiles=g;c.each(p||g,function(f,g){var h=c.extend({},b);h.files=p?g:[g];h.paramName=q[f];d._initResponseObject(h);
d._initProgressObject(h);d._addConvenienceMethods(a,h);return e=d._trigger("add",c.Event("add",{delegatedEvent:a}),h)});return e},_replaceFileInput:function(a){var b=a.fileInput,d=b.clone(!0),e=b.is(document.activeElement);a.fileInputClone=d;c("<form></form>").append(d)[0].reset();b.after(d).detach();e&&d.focus();c.cleanData(b.unbind("remove"));this.options.fileInput=this.options.fileInput.map(function(a,c){return c===b[0]?d[0]:c});b[0]===this.element[0]&&(this.element=d)},_handleFileTreeEntry:function(a,
b){var d=this,e=c.Deferred(),f=[],g=function(b){b&&!b.entry&&(b.entry=a);e.resolve([b])},k=function(c){d._handleFileTreeEntries(c,b+a.name+"/").done(function(a){e.resolve(a)}).fail(g)},h=function(){t.readEntries(function(a){a.length?(f=f.concat(a),h()):k(f)},g)};b=b||"";if(a.isFile)a._file?(a._file.relativePath=b,e.resolve(a._file)):a.file(function(a){a.relativePath=b;e.resolve(a)},g);else if(a.isDirectory){var t=a.createReader();h()}else e.resolve([]);return e.promise()},_handleFileTreeEntries:function(a,
