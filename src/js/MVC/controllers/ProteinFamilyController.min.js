...
c[0]=parseInt(Math.round(c[0]));c[1]=parseInt(Math.round(c[1]));var d=b._model.getSelectedResidues(a.semantic).selection;d[0]===c[0]&&d[1]===c[1]||b._model.setSelectedResidues(a.semantic,c)}});b._brushViews[a.semantic]=c})}function m(a){$("#residueSummaryView").load("./src/html/frequencyViewerWithOverlayTemplate.html",function(){var c=b._view.getYDimensionSize(),g=b._model.getSelectedProtein();a.forEach(function(a){var d=new ResidueFrequencyView(b._model,_.assign(a,{rows:c}));b._frequencyViews[a.semantic]=d;
