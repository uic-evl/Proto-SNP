...
const ProteinFamilyView = (function() {
  ...
  function ProteinFamilyView(model, element) {
    ...
    function setup_menu(alignment_name) {
    ...
    self.file_loaded = function (data, extension, name) {
      ...
      return initialize_file_open(d3.select('#family_upload_li'));
    };
    ...
    self.initialize = function (data) {
      ...
      /* Setup the menu */
      setup_menu(this._model.getFileName());
