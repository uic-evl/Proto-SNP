...
//let alignment = new AlignPairLinear();
...
function path (i1, j1, i2, j2) {
    ...
    if ((i1 + 1 === i2) || (j1 === j2)) {
        ...
        let maxValue = this.Sn[j1] + this.Sp[j1];
        let maxJ = j1;
