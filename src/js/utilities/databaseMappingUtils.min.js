...
$jscomp.polyfill=function(a,d,e,f){if(d){e=$jscomp.global;a=a.split(".");for(f=0;f<a.length-1;f++){var b=a[f];b in e||(e[b]={});e=e[b]}a=a[a.length-1];f=e[a];d=d(f);d!=f&&null!=d&&$jscomp.defineProperty(e,a,{configurable:!0,writable:!0,value:d})}};$jscomp.FORCE_POLYFILL_PROMISE=!1;
...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var h=new d;b.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};b.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(l){c.reject(l)}};b.prototype.then=function(a,d){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(m){f(m)}}:b}var e,f,g=new b(function(a,
b){e=a;f=b});this.callWhenSettled_(c(a,e),c(d,f));return g};b.prototype.catch=function(a){return this.then(void 0,a)};b.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?h.asyncExecute(c):this.onSettledCallbacks_.push(function(){h.asyncExecute(c)})};b.resolve=e;b.reject=function(a){return new b(function(b,c){c(a)})};b.race=function(a){return new b(function(b,
c){for(var d=$jscomp.makeIterator(a),f=d.next();!f.done;f=d.next())e(f.value).callWhenSettled_(b,c)})};b.all=function(a){var c=$jscomp.makeIterator(a),d=c.next();return d.done?e([]):new b(function(a,b){function f(b){return function(c){h[b]=c;g--;0==g&&a(h)}}var h=[],g=0;do h.push(void 0),g++,e(d.value).callWhenSettled_(f(h.length-1),b),d=c.next();while(!d.done)})};return b},"es6","es3");
var App=App||{},DatabaseMappingUtils=function(){return{mnemonicToPDB:function(a){return new Promise(function(d,e){d3.tsv("http://www.uniprot.org/uniprot/?query="+a+"&format=tab&compress=no&columns=entry name,database(PDB)",function(a){if(a[0]){var b=[];a.forEach(function(a){b.push({PDB:_.dropRight(a["Cross-reference (PDB)"].split(";")),mnemonic:a["Entry name"]})});d(b)}else e(null)})})},checkPDBs:function(a){return new Promise(function(d,e){d3.xml("http://www.rcsb.org/pdb/rest/idStatus?structureId="+
a,function(a){d([].map.call(a.querySelectorAll("record"),function(a){a=d3.select(a);return{pdb:a.attr("structureId"),status:a.attr("status")}}))})})},queryForUniprotIdentifiers:function(a){return new Promise(function(d,e){$.post("http://www.uniprot.org/uploadlists/",{from:"ACC+ID",to:"ACC",format:"tab",columns:"id,entry_name,reviewed,protein_names,length,database(PDB)",query:a}).done(function(a){d([].map.call(d3.tsvParse(a),function(a){return{pdb:a["Cross-reference (PDB)"],id:a["Entry name"]}}))})})}}};
